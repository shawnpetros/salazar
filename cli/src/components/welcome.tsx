  ...
  return (
    <Box flexDirection="column" alignItems="center" paddingTop={1} paddingBottom={1}>
      <Gradient name="rainbow">
        <Text bold>{"⬡ Harness — Autonomous Code Builder"}</Text>
      </Gradient>
      <Box marginTop={1}>
        <Text dimColor>
...
export function ReadyScreen({ onDone }: ReadyScreenProps): React.ReactElement {
  ...
  return (
    <Box flexDirection="column" paddingTop={1} paddingBottom={1}>
      <Text color="green">{"✓ Configuration saved to ~/.harness/config.json"}</Text>
      <Box marginTop={1} flexDirection="column">
        <Text bold>{"Quick-start examples:"}</Text>
        <Box marginTop={1} flexDirection="column">
          <Text>{"  harness run spec.md"}</Text>
          <Text>{"  harness run --multi spec.md"}</Text>
          <Text>{"  harness config"}</Text>
          <Text>{"  harness history"}</Text>
        </Box>
      </Box>
      <Box marginTop={2}>
        <Text color="cyan">{"Press Enter to continue"}</Text>
